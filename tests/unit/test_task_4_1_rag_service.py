...
class TestRAGService:
    ...
    def setup_service(self):
        ...
        self.rag_service._generate_ai_response = AsyncMock(return_value="This is a test response.")
    ...
    async def test_generate_response_with_analysis_context(self, mock_search_result, mock_analysis_context):
        ...
        # Verify AI response generation was called
        self.rag_service._generate_ai_response.assert_called_once()
        # Check that the prompt contains the expected context
        call_args = self.rag_service._generate_ai_response.call_args
