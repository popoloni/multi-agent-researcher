...
async def test_rag_service_integration():
    ...
    # FIXED: Mock the correct method that RAG service actually calls
    rag_service._generate_ai_response = AsyncMock()
    rag_service._generate_ai_response.return_value = {
        "analysis": {
...
async def test_rag_and_chat_history_integration():
    ...
    # Verify service calls - FIXED: Check the correct method that was actually called
    ...
    rag_service._generate_ai_response.assert_called_once()  # FIXED: Check the correct method