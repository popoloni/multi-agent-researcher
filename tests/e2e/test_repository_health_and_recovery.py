...
class TestAnalysisWithHealthCheck:
    ...
    async def test_analysis_unhealthy_repository_auto_recover(self, temp_repo_service, temp_repository):
        ...
        # Mock the check_repository_health method to return unhealthy first, then healthy
        ...
        async def mock_health_check(repo_id):
            ...
            if health_check_calls == 1:
                ...
                return {
                    ...
                    "message": "Repository local path does not exist"
                }
            else:
        ...
        temp_repo_service.check_repository_health = AsyncMock(side_effect=mock_health_check)
